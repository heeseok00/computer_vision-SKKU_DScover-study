...
$$\text{class-specific confidence for bbox1, class } j = \underbrace{c_1}_{\text{bbox1 confidence}} \times \underbrace{\text{class score}_{j}}_{P(\text{class}_{j} \mid \text{obj})}$$
